    ...
    public partial class M06_MFA : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:multi_factor_hmac", "unknown,md5,sha1,sha256,sha384,sha512")
                .Annotation("Npgsql:Enum:multi_factor_type", "unknown,google")
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .OldAnnotation("Npgsql:Enum:ctf_challenge_difficulty", "none,very_easy,easy,medium,hard,very_hard,ultra_nightmare")
                .OldAnnotation("Npgsql:Enum:ctf_challenge_endpoint_type", "unknown,netcat,http,ssh,ssl,https")
                .OldAnnotation("Npgsql:Enum:multi_factor_hmac", "unknown,md5,sha1,sha256,sha384,sha512")
                .OldAnnotation("Npgsql:Enum:multi_factor_type", "unknown,google");
        }
    }
}
