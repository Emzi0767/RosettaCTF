...
{
    /// <summary>
    /// Represents an initializer for OAuth providers. An implementation configures appropriate services for supplied collection.
    /// </summary>
    public interface IOAuthProviderServiceInitializer
    {
        /// <summary>
